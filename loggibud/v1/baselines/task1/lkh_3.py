...
def solve(
    ...
    return read_solution(instance, params)
...
def read_solution(instance: CVRPInstance, params: LKHParams) -> CVRPSolution:
    ...
    The output is somewhat weird: It generates a output file with all routes
    in a TSPLIB format. It has indices of the packages in order for each route.
